...
namespace C1Input101
{
    public class Country
    {
        ...
        public static IEnumerable<Country> GetDemoDataList()
        {
            ...
            return countries.Select(name => new Country { Name = name });
        }
    }
    ...
    public class CountryWithFlag
    {
        ...
        public static IEnumerable<CountryWithFlag> GetDemoDataList()
        {
            var array = new List<CountryWithFlag>();
            ...
            return array as IEnumerable<CountryWithFlag>;
        }
    }
}
