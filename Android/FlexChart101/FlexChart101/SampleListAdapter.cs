...
namespace FlexChart101
{
    class SampleListAdapter : BaseAdapter
    {
        ...
        public SampleListAdapter(Context context)
        {
            ...
            SampleModel treeMap = new SampleModel(context.Resources.GetString(Resource.String.treeMap), context.Resources.GetString(
                          Resource.String.treeMapDesc), Resource.Drawable.chart_treeMap, typeof(TreeMapActivity));
            ...
            SampleModel customPlotElementsScrolling = new SampleModel(context.Resources.GetString(Resource.String.customPlotElementsScrolling), context.Resources.GetString(
                          Resource.String.customPlotElementsScrollingDesc), Resource.Drawable.custom, typeof(CustomPlotElementsScrollingActivity));
            ...
            list.Add(customPlotElementsScrolling);
