    ...
    public class FlagConverter : IValueConverter
    {
        ...
        public FlagConverter()
        {
            ...
            for (int i = 0; i < Country.Countries.Length; i++)
            {
                ...
                var resName = string.Format("C1Input101.Images.{0}.png", strFlag.ToLower());
                if (assembly.GetManifestResourceNames().Contains(resName))
                    flags.Add(strFlag, ImageSource.FromResource(resName, typeof(App)));
            }
        }
