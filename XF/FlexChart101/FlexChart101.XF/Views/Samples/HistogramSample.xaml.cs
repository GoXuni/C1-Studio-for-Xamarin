...
namespace FlexChart101
{
    public  partial class HistogramSample 
    {
        public HistogramSample()
        {
            ...
            Title = AppResources.HistogramTitle;
            this.binWidthLabel.Text = AppResources.BinWidth;
            flexChart.ItemsSource = Data;
            List<Color> CustomPalette = new List<Color> { Color.FromHex("#03A9F4"), Color.FromHex("#f44336") };
