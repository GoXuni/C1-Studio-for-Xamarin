...
namespace FlexGrid101
{
    public class YouTubeCollectionView : C1CursorCollectionView<YouTubeVideo>
    {
        ...
        {
            var youtubeUrl = string.Format("https://www.googleapis.com/youtube/v3/videos?part=snippet,statistics&id={0}&key={1}", string.Join(",", ids), "AIzaSyCtwKIq-Td5FBNOlvOiWEJaClRBDyq-ZsU");
