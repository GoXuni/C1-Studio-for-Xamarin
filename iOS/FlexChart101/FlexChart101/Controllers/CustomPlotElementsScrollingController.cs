...
{
    public partial class CustomPlotElementsScrollingController : UIViewController
    {
        public CustomPlotElementsScrollingController() : base("CustomPlotElementsController", null)
        {
        }

        public CustomPlotElementsScrollingController(IntPtr handle) : base(handle)
        {
        }
        FlexChart chart;
