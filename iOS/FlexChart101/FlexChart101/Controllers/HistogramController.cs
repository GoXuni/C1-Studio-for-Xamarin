...
{
    public partial class HistogramController : UIViewController
    {
        FlexChart chart;
        public HistogramController() : base("HistogramController", null)
        {
        }

        public HistogramController(IntPtr handle) : base(handle)
        {
        }
        ...
        public override void ViewDidLoad()
        {
            ...
            chart.BindingX = "X";
            chart.Binding = "Y";
            chart.Series.Add(new Histogram() { SeriesName = "Frequency", Style = new ChartStyle { StrokeThickness = 1, Fill = UIColor.Clear.FromHex(0x03A9F4), Stroke = UIColor.Clear.FromHex(0x3F51B5) } });
            chart.Series.Add(new ChartSeries() { SeriesName = "Value", ChartType=ChartType.Scatter, Style = new ChartStyle { StrokeThickness = 2, Fill = UIColor.Clear.FromHex(0xf44336), Stroke = UIColor.Clear.FromHex(0x9C27B0) } });
            chart.ItemsSource = Data;
            this.Add(chart);

            chart.Rendered += (object sender, RenderEventArgs e) => 
            {
                if(string.IsNullOrEmpty(textBox.Text))
                {
                    Histogram histogram = chart.Series[0] as Histogram;
        ...
        public override void ViewDidLayoutSubviews()
        {
            ...
            chart.Frame = new CGRect(this.View.Frame.X, this.View.Frame.Y + 130,
                                         this.View.Frame.Width, this.View.Frame.Height - 130);
        }
